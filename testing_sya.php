...
// Make sure db.php has the function getSyaDB() inside it!
include "db.php"; 

echo "<div style='font-family: sans-serif; padding: 20px;'>";
echo "<h1>Sya's Database Inspector</h1>";

// 1. CONNECT TO SYA
$pdo = getSyaDB();

if (!$pdo) {
    die("<h2 style='color:red'>Connection Failed. Check Sya's IP/User/Pass in db.php</h2>");
}

echo "<h3 style='color:green'>Success! Connected to Sya. Fetching data...</h3><hr>";
...
try {
    ...
    if (count($tables) == 0) {
        echo "<p>Connected, but <strong>no tables found</strong> in Sya's database.</p>";
    }
