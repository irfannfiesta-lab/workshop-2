...
// Make sure db.php has the function getAfifDB() inside it!
include "db.php"; 

echo "<div style='font-family: sans-serif; padding: 20px;'>";
echo "<h1>Afif's Database Inspector</h1>";

// 1. CONNECT TO AFIF
$pdo = getAfifDB();

if (!$pdo) {
    die("<h2 style='color:red'>Connection Failed. Check Afif's IP/User/Pass in db.php</h2>");
}

echo "<h3 style='color:green'>Success! Connected to Afif. Fetching data...</h3><hr>";
...
try {
    ...
    if (count($tables) == 0) {
        echo "<p>Connected, but <strong>no tables found</strong> in Afif's database.</p>";
    }
