...
// Make sure db.php has the function getAdlinDB() inside it!
include "db.php"; 

echo "<div style='font-family: sans-serif; padding: 20px;'>";
echo "<h1>Adlin's Database Inspector</h1>";
// 1. CONNECT TO ADLIN
$pdo = getAdlinDB();

if (!$pdo) {
    die("<h2 style='color:red'>Connection Failed. Check Adlin's IP/User/Pass in db.php</h2>");
}

echo "<h3 style='color:green'>Success! Connected to Adlin. Fetching data...</h3><hr>";
...
try {
    ...
    if (count($tables) == 0) {
        echo "<p>Connected, but <strong>no tables found</strong> in Adlin's database.</p>";
    }
