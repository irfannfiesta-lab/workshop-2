...
<div class="content">
    ...
    <div class="logbook-wrapper">
        ...
        <div class="logbook-box">
            ...
            <label>Date</label>
            <input type="text" id="date" class="date-display" value="<?php echo date('F j, Y'); ?>" readonly>
        </div>
        ...
        <div class="attachment-box">
            ...
            <button class="view-btn" onclick="previewFile()">View</button>

            <div class="preview-box" id="previewBox"></div>

            <button class="submit-btn">Submit Logbook</button>
        </div>
...
function previewFile() {
    ...
    reader.onload = function(e) {
        if (file.type === "application/pdf") {
            previewBox.innerHTML = `<iframe src="${e.target.result}" width="100%" height="420px"></iframe>`;
        } else {
